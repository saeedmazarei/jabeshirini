...
function registerUser() {
  ...
  form.append("hash_id", hashId);
  form.append("challenge", "GemBox");

  var settings = {
    "url": "https://quizofkings.com/challenge-api/v1/challenge/register",
    "method": "POST",
    "timeout": 0,
    "processData": false,
...
function claimApi(mission) {
  ...
  form.append("hash_id", hashId);
  form.append("challenge", "GemBox");
  form.append("mission_id", mission);

  var settings = {
    "url": "https://quizofkings.com/challenge-api/v1/challenge/claim",
    "method": "POST",
    "timeout": 0,
    "processData": false,
    "mimeType": "multipart/form-data",
  ...
  //   redirect: 'follow'
  // };
  // fetch("https://quizofkings.com/challenge-api/v1/challenge/claim", requestOptions).then(function (response) {
  //   response.text();
...
function landingApi() {
  $("#loading").removeClass("deactive");
  var settings = {
    "url": "https://quizofkings.com/challenge-api/v1/challenge/landing?hash_id=".concat(hashId, "&challenge=GemBox"),
    "method": "GET",
    "timeout": 0,
  };
  
  $.ajax(settings).done(function (response) {
    landingData = response;
    main();
    $("#loading").addClass("deactive");
  });
}
